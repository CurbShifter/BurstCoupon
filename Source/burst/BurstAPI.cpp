...
var BurstAPI::GetUnconfirmedTransactions()
{
	return GetJSON(host + "burst?requestType=getUnconfirmedTransactions");
}

var BurstAPI::GetUnconfirmedTransactionsIds()
{
	return GetJSON(host + "burst?requestType=getUnconfirmedTransactionIds");
}
...
var BurstAPI::SendMoney(String recipient, String amountNQT, String feeNQT, String deadlineMinutes, bool broadcast)
{
	...
	if (broadcast)
		return SignAndBroadcast(unsignedTransactionBytesStr);
	else return Sign(unsignedTransactionBytesStr);
}

var BurstAPI::SignAndBroadcast(String unsignedTransactionBytesStr)
{
	return Broadcast(Sign(unsignedTransactionBytesStr));
}

var BurstAPI::Sign(String unsignedTransactionBytesStr)
{
...
{
	if (transactionBytesHex.isNotEmpty())
	{
